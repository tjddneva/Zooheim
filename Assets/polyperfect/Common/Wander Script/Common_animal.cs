...
namespace Polyperfect.Common
{
    ...
    public class Common_animal : MonoBehaviour
    {
        ...
        private static List<Common_animal> allAnimals = new List<Common_animal>();

        public static List<Common_animal> AllAnimals
        {
        ...
        Common_animal primaryPrey;
        Common_animal primaryPursuer;
        Common_animal attackTarget;
        float moveSpeed = 0f;
        ...
        float CalcAttackRange(Common_animal other)
        {
